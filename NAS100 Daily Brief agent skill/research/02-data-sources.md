...
| **NewsMCP** (`@newsmcp/server`) | **410 — service shut down** | ✅ Removed from `.mcp.json` |
| **Tavily MCP** | **401** — held the literal placeholder `YOUR_TAVILY_API_KEY` | ✅ Removed from `.mcp.json`; built-in WebSearch covers it |
