...
3. Mark the surviving confirmed pools: equal highs/lows, respected old highs/lows, chains of tapped lows to the left (Video 3, [1:52]–[2:27]).
4. Mark HTF liquidity blocks (extreme sweeps that never got respected) as blue boxes (Video 3, [2:27]–[3:06]).
