...
The channel restates, in fresh recordings across 6 months, essentially every core rule of files 01–04. One-line confirmations (no new content, cite = one clean instance):

| Rule (doc section) | IET confirmation |
|---|---|
| Respect + move-away = liquidity (01 §5a) | "Low taken. Price comes back up to the highs, respects it, moves away. This is going to be a level of liquidity" (IET 2026-01-31 [03:58]–[04:04]); the negative case: "if this high never touched into this high... then you wouldn't be plotting a line on this high" (IET 2026-07-21 [04:46]–[05:06]) |
| Market communicates, never predict (01 §5) | "we actually didn't even predict that... we let the market communicate that to us" (IET 2026-04-14 [06:14]); "Don't predict, always react" (IET 2026-04-07 [06:49]) |
| Enter on the stab, no over-refinement (03 §2.1) | "I don't need the top of the imbalance or the very extreme... I just want to enter as soon as that liquidity is taken" (IET 2026-04-21 [08:04]–[08:24]); "just so we don't overrefine, which is some people's mistake" (IET 2026-07-14 [01:13]) |
| Stop structural, covers the left-hand low/LB (03 §3.1) | "stop loss always covers this low to the left-hand side" (IET 2026-02-10 [07:07]); "above the liquidity block always. That never changes" (IET 2026-07-14 [15:56]) |
| Target = opposing pool, never fixed R (03 §4.1) | "where do you think they will be placing their stop losses...? We are going to be targeting their liquidity" (IET 2026-03-03 [07:52]–[08:12]) |
| Layered targets, partial at internal pools (03 §4.2) | "you have partial point one over here... the second one being here" (IET 2026-04-14 [09:14]); "these are levels you can either manage your trade or close or partial" (IET 2026-04-21 [09:04]) |
| Reactions in trap zones are false/short-lived (01 §6) | "any bullish reactions, deem them to be false... a trap" (IET 2026-04-21 [10:04]); "deem this pullback to be false and short-lived" (IET 2026-01-31 [07:23]–[07:43]) |
| Fractality (01 §8) | "this exact setup will literally occur on the hourly, on the 4-hour, on the daily, on the weekly. The only difference is how long it takes to play out" (IET 2026-03-17 [07:24]); "everything I do on the higher time frames, I apply to the lower" (IET 2026-06-30 [05:44]–[06:04]) |
| Anti-pattern warning (01 §9) | "that's called patterns and we're not trading patterns, we're looking for logic" (IET 2026-04-21 [05:43]); "I have one entry model, and it's not a pattern, it's logic" (IET 2026-06-30 [07:04]) |
| Wait when no liquidity (02 §C step 4) | "when you don't see liquidity, what do you do? Quite simple. We wait" (IET 2026-01-31 [01:22]) |
| Early traders trapped before entry (03 §1.4) | formalized as a written rule: "**we must only trade once the early traders are trapped. No ifs, ands, or buts**" (IET 2026-06-09 [07:05]–[09:05]) |
| Engineered liquidity (03 §1.3) | term used natively: "this now acts as engineered liquidity same as this high" (IET 2026-04-14 [03:53]–[04:13]); "we engineered liquidity at the lows" (IET 2026-07-21 [01:26]–[01:46]) |
| Re-stabs after entry don't invalidate (03 §6) | "price can sometimes stab in, give a false reaction and then stab in higher and then the move occurs" (IET 2026-02-24 [05:24]) |
| Missed/failed target acceptance (03 §5.2, 04 §8) | "if we make it to the highs, payday. If we don't make it to the highs, $0... Is am I following my plan? That's all you need to be asking" (IET 2026-06-30 [07:24]–[08:24]) |
| Structural liquidity (01 §7 / 06) | given a diagrammatic definition: "liquidity below higher lows... liquidity above lower highs. That's why we call it structure liquidity" (IET 2026-06-09 [05:05]–[05:45]) |
| Trendline liquidity collapses to liquidity (02 §B.5) | "perfect trend line liquidity, whatever you want to call it... we've got a bunch of seller liquidity above all these highs" (IET 2026-07-21 [03:46]–[04:06]) |
| Untaken pools persist as future targets (01 §4) | "leave the lows marked on or leave the highs marked on. It will be used in the future" (IET 2026-04-07 [01:02]) |
| Sessions: NY futures window (04 §5) | "I only ever take trades within New York session on the indexes. I would say 90% of the time" (IET 2026-07-21 [10:27]); forex limits run overnight (IET 2026-05-05 [04:52]) |

## 7. Extensions and divergences from files 01–04

Ordered by importance. "Extension" = new rule consistent with the docs; "divergence" = conflicts with something previously recorded.

1. **[Extension, load-bearing] "No liquidity block, no entry."** Stated as a personal hard rule: "a simple rule for myself, a very simple rule is no liquidity block, no entry. Even though you identified the liquidity and everything... if you don't have an area to place your stop loss, guess what? We are not entering" (IET 2026-07-14 [07:55]–[08:15]); "no liquidity block, no stop loss. We need an LB to take an entry" (IET 2026-03-10 [05:12]). File 03 §1.5 recorded this only as "should sit beyond the entry" with V2 skipping when the LB is far. IET's formulation upgrades Rule 1.5 to a hard gate — and file 08 §F's State-4 gate should be treated as mandatory, not optional. Fallback when no LB exists: wait for an LTF confirmation — "if there's no liquidity block to the left-hand side, I need to look for a confirmation. What does that look like? The same thing [the model] on the lower time frames" (IET 2026-06-30 [06:24]–[07:04]) — which matches file 03 §2.3's fractal drop-down.
2. **[Extension] The time apparatus** (§3.4–3.5): H4 6–10 a.m. candle model, 10:00 a.m. reversal, PDH/PDL day-frame, inside-day and bank-holiday no-trade calls, Asia-open confluence, candle-closure entries allowed only on perfect time confluence. Files 01–04 have only V1's session window and news blackout. This is the largest block of genuinely new procedure.
3. **[Divergence — management] Break-even without partials.** The official playbook says "No break-even stops unless partials have been taken" (Playbook p.03), siding with V1. IET repeatedly goes risk-free *without* paying itself: "as soon as we took out this low, I'm going break even. **I'm not paying myself.** Why? [the level is only] 1-to-2.5. If it doesn't make sense RR-wise, the partial — I'm not going to do it" (IET 2026-07-14 [20:18]–[20:38]); "once we took out this internal high, I went risk-free" (IET 2026-06-30 [01:23]). The synthesis across all sources now reads: BE/risk-off is gated on *a liquidity level being consumed in your favor* (V2/V3/IET) with the partial decision made separately by RR-at-that-level (IET's refinement: partial only if the level pays ≥ ~1:5–1:6, else BE only — "as soon as we traded below this low, I am paying myself. Why? 1-to-6. Why would I not?", IET 2026-07-14 [20:38]–[20:58]). The playbook/V1 "no BE unless partialed" is the odd one out — see file 05 update.
4. **[Extension] Trail-to-new-LB.** A new trailing anchor rule from the live stream: "the reason why I'm going to roll now is because we've created some sort of an LB here... **This LB should protect my SL. If it runs it, I don't want to be in the trade no more**" (IET 2026-06-30 [10:08]–[10:28]) — i.e., stops trail behind freshly-minted LBs, not arbitrary higher lows; noted as futures-specific urgency ("for futures, different. Cuz I have to be in and out in the same day", [10:08]).
5. **[Extension] Probability-graded lockout with a time exception** (§3.3): "sells automatically deemed lower probability... you need to pair it with time" (IET 2026-04-28 [01:02]) vs V1's absolute "I will not buy" (file 02 §D). Functionally a softening that licenses the ping-pong day.
6. **[Divergence — vocabulary] Imbalance ≈ liquidity block** (§2.6). Files 01–06 catalogue FVG/imbalance strictly as retail trap-zone vocabulary; IET uses the sweep's imbalance as the LB's geometry and parks limits inside it. Same object, opposite connotation — a glossary update (file 06).
7. **[Extension] Stacking rule** (§5): target-intact ⇒ another opportunity; stack dies with the target. New relative to V1's in-trade scale-ins.
8. **[Extension] 4H-candle "nature" veto:** a bullish 4H close followed by a candle that *respects* rather than runs the prior low is "a bit of a red flag... I personally just like to sit out in these situations" (IET 2026-07-21 [09:27]–[10:07]) — a candle-behavior quality filter with no analogue in files 01–04.
9. **[Extension] Anticipating ≠ trading:** "Just because you anticipate a reaction to occur does not mean you need to be taking a trade. Identifying a trade opportunity and identifying just the market having a reaction is two different things" (IET 2026-06-30 [04:44]–[05:04]). Pairs with §2.4's untraded LBs.
10. **[Extension — practice layer] Frequency and risk posture:** "all you need, I promise you, is maybe one to three trades per week" (IET 2026-02-03 [07:27]); backtest-with-replay-tool training regime (Tradezella / FX Replay / TradingView bar replay, IET 2026-02-03 [02:27]–[03:07]); prop-firm laddering from small accounts (IET 2026-02-03 [08:27]–[10:27]); execution scale: "I'm copy trading 10 funded accounts... it's a million dollars in capital I'm trading... I don't use a lot of risk — I have two micros on" (IET 2026-06-30 [05:04]–[05:24]).
11. **[Unverified money claims, for the record]:** $3,300 AUDUSD (2026-03-03), $6,600 USDJPY at 75% closed (2026-02-24), ~$10,000 gold in 4 minutes / 290 ticks in 1 minute (2026-03-17), >$8,000 gold (2026-05-13), $5,700 futures + $2,800 CFD live (2026-06-30), "one trade passed all five [Apex] accounts... $500,000 in challenges" (2026-04-21 [11:24]). Same marketing-grade caveat as file 04 §7; the channel is sponsored by Alpha Capital / Alpha Futures (recurring ad read, e.g. IET 2026-07-14 [02:33]–[03:13]).

**Bot-blueprint impact (file 08), summarized:** make the LB gate mandatory (item 1); add a time-qualifier module (H4 roll, stock open, PDH/PDL frame — item 2); implement BE-on-first-pool-consumed with RR-conditional partials (item 3); consider LB-trailing (item 4); the lockout becomes a scored filter rather than a boolean when a time qualifier is present (item 5).
