...
All rules below are written for the **bullish (long) case**. Every source states the bearish case is the exact inversion (V1 [25:08]; V2 [6:14]: "you guys can literally just invert this"; V2 [22:20]–[22:44]; V2 [24:52]–[29:07] draws the full short version; V3 trades only longs in its example but uses the same mirrored language for sells).
...
| 6 | V2 [30:40]–[43:33] | Gold 15m + 1m | HTF Da Vinci for direction + 1m Da Vinci for entry; last-level-of-liquidity stab | 1:12 extreme / ~1:5 conservative |
